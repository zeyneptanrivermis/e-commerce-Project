export const CATEGORY_IMAGES: { [key: string]: string } = {
  ...
  TOYS_AND_GAMES: 'assets/images/oyuncak.png',
  PET_SUPPLIES: 'assets/images/hayvan.png',
  SPORTS_AND_OUTDOOR: 'assets/images/spor.jpg',
  HOBBY_PRODUCTS: 'assets/images/hobi.png',
